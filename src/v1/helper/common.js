                    ...
                    <tr>
                      <td class="wrapper">
                        <table role="presentation" border="0" cellpadding="0" cellspacing="0">
                          <tr>
                            <td>
                              <h1>Welcome to Zwallet!</h1>
                              <p>So lovely to have you joined us! Please click the CONFIRM button below to verify your account.</p>
                    ...
                    <table role="presentation" border="0" cellpadding="0" cellspacing="0">
                      <tr>
                        <td class="content-block">
                          <span class="apple-link">2020 Zwallet. All right reserved.</span>
                        </td>
                      </tr>
                      <tr>
